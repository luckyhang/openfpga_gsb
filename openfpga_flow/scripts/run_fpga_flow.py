...
def validate_command_line_arguments():
    ...
    # Filter provided openshell template file
    args.openfpga_shell_template = os.path.abspath(args.openfpga_shell_template)
    if not os.path.isfile(args.openfpga_shell_template):
        clean_up_and_exit("openfpga shell template file not found. -%s",args.openfpga_shell_template)

    
    # Filter provided openfpga architecture file
    ...
    #Filter provided openfpga_sim_setting_file
    ...
    if not os.path.isfile(args.openfpga_sim_setting_file):
        clean_up_and_exit("openfpga sim setting file not found. -%s",args.openfpga_sim_setting_file)
